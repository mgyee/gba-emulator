...
void CPU::arm_bx(uint32_t instr) {
...
void CPU::arm_bdt(uint32_t instr) {
...
void CPU::arm_bl(uint32_t instr) {
...
void CPU::arm_sdt(uint32_t instr) {
...
void CPU::arm_psrt(uint32_t instr) {
...
void CPU::arm_dproc(uint32_t instr) {
  bool i = (instr >> 25) & 0x1; // imm/reg
